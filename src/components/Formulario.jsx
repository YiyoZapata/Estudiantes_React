...
const Formulario = ({setEstudiantes, estudiantes, estudiante, setEstudiante}) => {
  ...
  const [DNI, setDocumento] = useState('')
  ...
  const enviarFormulario = (e) => {
    ...
    //validar campos
    if([DNI,nombre,apellido,correo,telefono].includes('')){
        setError(true)
        return
    }else setError(false)

    //guardando
    const obj = {DNI,nombre,apellido,correo,telefono}
    if(estudiante.id){
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="input-group mb-3">
              ...
              <input type="number" className="form-control" value={DNI}
